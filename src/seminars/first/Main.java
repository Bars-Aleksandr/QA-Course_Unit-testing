...
//        happyNY();
    ...
    public static void assertConditionA() {
        ...
        System.out.println("A) В неделе " + weekends.length + " дня выходных");
    }
    ...
    public static int sum(int a, int b) {
        assert (a + b) <= Integer.MAX_VALUE: "Превышен предел для int";
        assert !(b < 0 && a < Integer.MIN_VALUE - b): "Превышен предел для int";
        return a + b;
    }
    ...
    public static void happyNY() {
        ...
        assert currentDateTime.equals("03/01/2025") : "Еще 2024 год :(";
        if (currentDateTime.equals("03/01/2025")){
            System.out.println("С новым годом!");}
        else System.out.println("Ждите новый год");
    }
    ...
    public static void expectedValue() {
        ...
        System.out.println("метод expectedValue() выполнился без исключения");
    }
...
//        assertThat(emmett.isHuman()).isEqualTo(true);
        ...
        */
        ...
        assert "sword".equals(emmett.getWeapon()): "The weapon must be of the type sword";
        assert !emmett.getBag().isEmpty(): "Еhe bag must not be empty";
        assert emmett.getBag().containsAll(Arrays.asList("Bow", "Axe", "Gold")): "The bag should contain Bow, Axe, Gold";
        assert emmett.isHuman(): "The hero must be human";
    }
